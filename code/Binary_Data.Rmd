...
n_no <- c(23, 67, 145, 56, 121)
n_total <- n_yes_total + n_no
percentages <- round((n_yes_total / n_total) * 100, 2)
...
# Display table
kable(result_df, col.names = c("Objective", "Yes", "No", "Total", "Percentage Yes"))
...
ggplot(result2, aes(x = reorder(objective, -yes), y = yes, fill = objective)) +
...
# export all figures into slides
...
```
edu_sect_summary
staff_binary_summary
funding_binary_summary
outcome_binary_summary
indicator_binary_summary
```{r}
