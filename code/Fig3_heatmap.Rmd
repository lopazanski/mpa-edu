...
heatmap_draft1 <- ggplot(edu_what_binary |> 
                           ...
                           mutate(region = factor(region, levels = c("Pacific","Indian"))),
...
heatmap_draft <- heatmap_draft1 + heatmap_draft2 +
  patchwork::plot_layout(widths = c(0.9, 1)) 

heatmap_draft

# heatmap_draft <- plot_grid(
#   heatmap_draft1, NULL, heatmap_draft2,
#   ncol = 3, align = "h",
#   rel_widths = c(0.9, 0, 1),
#   axis = "b")

## order strategies -> convert to factor
ggsave(file.path('figs', "Fig3_heatmap.png"), heatmap_draft, width = 13, height = 12, units = "in")
```
